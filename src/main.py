...
def main():
    ...
    data.load_sphere(0.75, 0.25, 0.75, 0.25, 1.0, 1.0, 1.0, 1.0)
    data.load_sphere(-1, 0.5, -3, 0.5, 1.0, 1.0, 1.0, 1.0)

    data.load_plane(0, 0, 0, 0, 1, 0, 0.5, 1.0, 0.5, 1.0)
    data.load_plane(0, 0, 1, 0, 0, -1, 1.0, 0.5, 0.5, 1.0)
    data.load_plane(0, 0, -1, 0, 0, 1, 0.5, 0.5, 1.0, 1.0)
    data.load_plane(-1, 0, 0, 1, 0, 0, 1.0, 0.5, 1.0, 1.0)
    data.load_plane(1, 0, 0, -1, 0, 0, 1.0, 1.0, 0.5, 1.0)
    data.load_plane(0, 2, 0, 0, -1, 0, 0.5, 1.0, 1.0, 1.0)
